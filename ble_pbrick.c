...
)
{
    ...
    attr_md.read_perm  = p_pbrick_init->lights_char_attr_md.read_perm;
    attr_md.write_perm = p_pbrick_init->lights_char_attr_md.write_perm;
    attr_md.vloc       = BLE_GATTS_VLOC_STACK;
    attr_md.rd_auth    = 0;
    attr_md.wr_auth    = 0;
    attr_md.vlen       = 0;
    ...
    ble_uuid.type = p_pbrick->uuid_type;
    ble_uuid.uuid = PBRICK_LIGHT_CHAR_UUID;
