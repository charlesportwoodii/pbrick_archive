...
#define PBRICK_PWM0_P1              NRF_GPIO_PIN_MAP(0, 5)
#define PBRICK_PWM0_P2              NRF_GPIO_PIN_MAP(0, 6)
...
#define PBRICK_LIGHT_LEFT_REAR      NRF_GPIO_PIN_MAP(0, 20)

// Rear lights
#define PBRICK_LIGHT_RIGHT_FRONT    NRF_GPIO_PIN_MAP(0, 21)
