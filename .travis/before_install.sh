...
if [ -z "$(ls -A $HOME/gcc-arm-none-eabi-8-2019-q3-major)" ]; then
    cd $HOME
    ...
    tar -xf gcc-arm-none-eabi-8-2019-q3-major-linux.tar.bz2
    rm -rf gcc-arm-none-eabi-8-2019-q3-major-linux.tar.bz2
else
    echo "gcc-arm-none-eabi-8-2019-q3-major-linux is already installed."
fi
